...
const INVOICE_SCHEMA = {
  ...
  properties: {
    ...
    transportMode: { type: Type.STRING, description: "Transport/Vehicle number" },
    grrrpr: { type: Type.STRING, description: "GR/RR/PR number" },
    ...
    clientState: { type: Type.STRING, description: "State name of the client" },
    clientStateCode: { type: Type.STRING, description: "State code of the client (e.g. 07 for Delhi)" },
    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          unit: { type: Type.STRING, description: "Unit of quantity e.g. Pcs, Set, Nos" },
